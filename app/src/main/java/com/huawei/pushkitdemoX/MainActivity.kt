...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            R.id.btn_get_aaid -> manager.getAAID { System.out.println("xx $it")
                showToast("btn_get_aaid $it") }
            R.id.btn_delete_aaid -> manager.deleteAAID {System.out.println("xx $it")
            ...
            R.id.btn_delete_token -> manager.deleteToken {System.out.println("xx $it")
                showToast("btn_delete_token $it") }
            R.id.btn_subs -> manager.subscribe(Constant.TOPIC_MESSAGE) {System.out.println("subs $it")
                showToast("btn_subs $it") }
            R.id.btn_unsubs -> manager.unSubscribe(Constant.TOPIC_MESSAGE) {System.out.println("xx $it")
            ...
            R.id.btn_get_creation_time -> manager.getCreationTime { showToast("btn_get_creation_time $it")
                System.out.println("getId $it")
            }
        }
    }
